...
"""Define the POM Discovery Celery entry point.

``@owned_by("pom_discovery")`` tags the task so the app-drain reconciler counts it
...
from app.sep.apps.pom_discovery.service import run_probe

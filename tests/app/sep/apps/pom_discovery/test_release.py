...
from app.sep.apps.pom_discovery.dispatch import probe_host
...
def _fast_timeout(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(pom_discovery_settings, "TASK_TIMEOUT", 1)
    monkeypatch.setattr(pom_discovery_settings, "POLL_INTERVAL", 1)

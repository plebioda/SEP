    ...
    tasks_list_tasks__get: {
        parameters: {
            query?: {
                ...
                sort?: "backend" | "-backend" | "created_at" | "-created_at" | "name" | "-name" | "owner" | "-owner" | "updated_at" | "-updated_at";
    ...
    tasks_list_task_history_history__get: {
        parameters: {
            query?: {
                ...
                limit?: number;
                /** @description Sort key; prefix with '-' for descending order. */
                sort?: "created_at" | "-created_at" | "executed_by" | "-executed_by" | "finished_at" | "-finished_at" | "started_at" | "-started_at" | "status" | "-status";
                /** @description Case-insensitive search across the searchable columns. */
                search?: string | null;
            };
            header?: never;

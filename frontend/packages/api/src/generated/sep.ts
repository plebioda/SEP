...
export interface components {
    schemas: {
         ...
         * @enum {string}
         */
        ConnectivityStatusEnum: "reachable" | "auth_failed" | "error" | "unreachable" | "ssl_error" | "timeout" | "not_configured" | "inputs_drifted" | "probe_undeclared";
        /**
         ...
         * @enum {string}
         */
        DeliveryConnectionStatusEnum: "available" | "undeclared" | "not_configured" | "inputs_drifted" | "fetch_failed";
        /**
         * ExecutionEvent
         ...
         * @enum {string}
         */
        ServiceTypeEnum: "mysql" | "postgresql" | "mongodb" | "proxysql" | "haproxy" | "external" | "valkey";
        /**
         * SettingClassGroup
         ...
         * @enum {string}
         */
        TaskHistoryStatusEnum: "failed" | "pending" | "running" | "success" | "stopped" | "lost" | "stale" | "unlaunchable";
        /** ValidationError */
        ValidationError: {
            /** Context */
        ...
        archives__ArchivesCreate: {
            ...
            /** Destination */
            destination?: (components["schemas"]["archives__DestByTable"] | components["schemas"]["archives__DestByFile"]) | null;
            /** Disable Binlog */
            ...
            extra_args?: string | null;
            /** Host */
            host?: (components["schemas"]["archives__HostByService"] | components["schemas"]["archives__HostManual"]) | null;
            /** Hostname */
            hostname: string;
            /** Limit */
            limit?: number | null;
            ...
            sleep?: number | null;
            /** Source */
            source: components["schemas"]["archives__SourceByTable"] | components["schemas"]["archives__SourceByQuery"];
            /**
             * Swap Drop
             * @default 0
             */
        ...
        atw__ATWMergedSchemaResponse: {
            ...
            /** Shared */
            shared: (components["schemas"]["framework__BoolField"] | components["schemas"]["framework__ChoiceField"] | components["schemas"]["framework__DateTimeField"] | components["schemas"]["framework__FileField"] | components["schemas"]["framework__FloatField"] | components["schemas"]["framework__HostField"] | components["schemas"]["framework__IntegerField"] | components["schemas"]["framework__MultiChoiceField"] | components["schemas"]["framework__MultiHostField"] | components["schemas"]["framework__MultiSchemaField"] | components["schemas"]["framework__MultiServiceField"] | components["schemas"]["framework__MultiTableField"] | components["schemas"]["framework__RemoteChoiceField"] | components["schemas"]["framework__SchemaField"] | components["schemas"]["framework__ScriptPreviewField"] | components["schemas"]["framework__ServiceField"] | components["schemas"]["framework__StringField"] | components["schemas"]["framework__TableField"] | components["schemas"]["framework__TextAreaField"] | components["schemas"]["framework__YamlField"] | components["schemas"]["framework__OneOfGroup"])[];
        };
        /**
         * ATWSnippetSchema
        ...
        atw__ATWSnippetSchema: {
            /** Fields */
            fields: (components["schemas"]["framework__BoolField"] | components["schemas"]["framework__ChoiceField"] | components["schemas"]["framework__DateTimeField"] | components["schemas"]["framework__FileField"] | components["schemas"]["framework__FloatField"] | components["schemas"]["framework__HostField"] | components["schemas"]["framework__IntegerField"] | components["schemas"]["framework__MultiChoiceField"] | components["schemas"]["framework__MultiHostField"] | components["schemas"]["framework__MultiSchemaField"] | components["schemas"]["framework__MultiServiceField"] | components["schemas"]["framework__MultiTableField"] | components["schemas"]["framework__RemoteChoiceField"] | components["schemas"]["framework__SchemaField"] | components["schemas"]["framework__ScriptPreviewField"] | components["schemas"]["framework__ServiceField"] | components["schemas"]["framework__StringField"] | components["schemas"]["framework__TableField"] | components["schemas"]["framework__TextAreaField"] | components["schemas"]["framework__YamlField"] | components["schemas"]["framework__OneOfGroup"])[];
            /** Snippet Filename */
            snippet_filename: string;
        };
        /**
         ...
         * @enum {string}
         */
        backup_mongo__BackupType: "pbm_logical" | "pbm_physical" | "pbm_incremental" | "pbm_snapshot" | "pbm_config" | "pbm_status";
        /**
         * CompressionAlgorithm
         * @description Represents algorithm of choice whem compressing wirteTiger datafiles.
         * @enum {string}
         */
        backup_mongo__CompressionAlgorithm: "gzip" | "snappy" | "lz4" | "s2" | "pgzip" | "zstd";
        ...
        backup_pg__BackupPgForm: {
            ...
            pgbackrest_backup_type?: components["schemas"]["backup_pg__PgBackRestBackupType"] | null;
            /** Pgbackrest Bin */
            ...
            pgbackrest_incremental_cycle?: ("daily" | "weekly" | "1" | "2" | "3" | "4" | "5" | "6" | "7") | null;
         ...
         * @enum {string}
         */
        framework__ColumnFormat: "text" | "chip" | "status" | "date" | "relative" | "code" | "actions" | "schedule";
        /**
         * ConnectivityWarning
        ...
        framework__OneOfBranch: {
            /** Fields */
            fields: (components["schemas"]["framework__BoolField"] | components["schemas"]["framework__ChoiceField"] | components["schemas"]["framework__DateTimeField"] | components["schemas"]["framework__FileField"] | components["schemas"]["framework__FloatField"] | components["schemas"]["framework__HostField"] | components["schemas"]["framework__IntegerField"] | components["schemas"]["framework__MultiChoiceField"] | components["schemas"]["framework__MultiHostField"] | components["schemas"]["framework__MultiSchemaField"] | components["schemas"]["framework__MultiServiceField"] | components["schemas"]["framework__MultiTableField"] | components["schemas"]["framework__RemoteChoiceField"] | components["schemas"]["framework__SchemaField"] | components["schemas"]["framework__ScriptPreviewField"] | components["schemas"]["framework__ServiceField"] | components["schemas"]["framework__StringField"] | components["schemas"]["framework__TableField"] | components["schemas"]["framework__TextAreaField"] | components["schemas"]["framework__YamlField"])[];
            /** Label */
            label: string;
            /** Value */
            value: string;
        ...
        mysql_backups__BackupCreate: {
            ...
            compression_algorithm?: components["schemas"]["mysql_backups__CompressionAlgorithm"] | null;
            /** Defaults File */
            ...
            xtrabackup_incremental_cycle?: ("daily" | "weekly" | "1" | "2" | "3" | "4" | "5" | "6" | "7") | null;
         ...
         * @enum {string}
         */
        nav_icons__NavIcon: "assignment" | "code" | "support-agent" | "description" | "troubleshoot" | "table-chart" | "check-circle" | "mysql" | "mongo" | "postgresql" | "archive" | "science" | "bar-chart" | "account-tree";
        /**
         * BootstrapRunStatus
         ...
         * @enum {string}
         */
        report__CheckSeverity: "SEVERITY_EMERGENCY" | "SEVERITY_ALERT" | "SEVERITY_CRITICAL" | "SEVERITY_ERROR" | "SEVERITY_WARNING" | "SEVERITY_NOTICE" | "SEVERITY_INFO" | "SEVERITY_DEBUG";
        /**
         * DiskUsageEntry
        ...
        topology__MySQLNodeData: {
            ...
            /** Port */
            port?: number | null;
            replication?: components["schemas"]["topology__MySQLReplicationInfo"] | null;
        ...
        topology__TopologyGraph: {
            /** Edges */
            edges?: (components["schemas"]["topology__ReplicationEdge"] | components["schemas"]["topology__DualPrimaryEdge"])[];
            /** Nodes */
            nodes?: (components["schemas"]["topology__MySQLNode"] | components["schemas"]["topology__ClusterNode"] | components["schemas"]["topology__UnknownSourceNode"])[];
...
export interface operations {
    ...
    atw_atw_snippet_search_api_apps_atw_snippets__get: {
        parameters: {
            query?: {
                ...
                sort?: "approved_at" | "-approved_at" | "created_at" | "-created_at" | "filename" | "-filename" | "service_type" | "-service_type" | "title" | "-title";
    ...
    inventory_inventory_sync_trigger_api_apps_inventory_sync__post: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["inventory__InventorySyncTriggerWrite"] | null;
            };
        };
        responses: {
            /** @description Successful Response */
